...
public class CollageApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        int yCoordinate = 0;
        int yCoordinateMiddle = height / 2;
        while (yCoordinate < height / 2) {
            int xCoordinate = 0;
            int xCoordinateMiddle = width / 2;
            while (xCoordinate < width / 2) {
                ...
                imageWriter.setColor(xCoordinateMiddle, yCoordinate, newColor);
                imageWriter.setColor(xCoordinate, yCoordinateMiddle, newColor);
                imageWriter.setColor(xCoordinateMiddle, yCoordinateMiddle, newColor);
